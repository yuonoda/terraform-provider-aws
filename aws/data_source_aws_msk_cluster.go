...
func dataSourceAwsMskClusterRead(d *schema.ResourceData, meta interface{}) error {
	...
	d.Set("bootstrap_brokers", bootstrapBrokersoOutput.BootstrapBrokerString)
	d.Set("bootstrap_brokers_sasl_scram", bootstrapBrokersoOutput.BootstrapBrokerStringSaslScram)
	d.Set("bootstrap_brokers_tls", bootstrapBrokersoOutput.BootstrapBrokerStringTls)
